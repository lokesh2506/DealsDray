...
const EmployeeCreate = () => {
  ...
  const [f_Image, setFile] = useState([]);
  const [role, setRole] = useState(["HR", "Manager", "Sales"]);

const {createEmployee,btnLoading} =useContext(EmployeeContext)
  ...
  return (
    <div className="p-2">
      <div className="flex justify-between ">
        <h2 className="text-2xl font-bold mb-6 mt-6">Create Employee Details</h2>
